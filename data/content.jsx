...
export const faqs = [
  ...
  {
    title: 'Why you should join the IoT Challenge?',
    body: (
      <p>
  ...
  {
    title: 'Can register more than 1 team?',
    body: (
      <p>
  ...
  },
  {
    ...
    body: (
      <ul>
        <li>- Innovation and originality (30%)</li>
        <li>- Impact (30%)</li>
        <li>- Technical feasibility (30%)</li>
        <li>- Document and Short Video (10%)</li>
      </ul>
    ),
  },
];
